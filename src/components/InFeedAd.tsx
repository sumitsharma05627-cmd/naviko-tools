...
export const InFeedAd: React.FC<InFeedAdProps> = ({ className = '' }) => {
  ...
  return (
    <section
      className={`w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-6 transition-all ${className}`}
